...
ON 
( NAME = MyPetShop,
  FILENAME = 'E:\ASP\test2\Ex8Site\App_Data\MyPetShop.mdf',
  SIZE = 5MB,
  MAXSIZE = 50MB,
  FILEGROWTH = 1MB )
LOG ON 
( NAME = MyPetShop_log,
  FILENAME = 'E:\ASP\test2\Ex8Site\App_Data\MyPetShop_log.ldf',
  SIZE = 3MB,
  MAXSIZE = 25MB,
  FILEGROWTH = 1MB )
...
INSERT INTO [Product] 
VALUES (4, 25.2, 23.5, 1, 'Flowerloving', 'Flowerloving', '~/Prod_Images/Birds/flowerloving.gif', 100)
INSERT INTO [Product] 
...
/*创建存储过程前先删除已存在的*/
IF EXISTS (SELECT * FROM sys.procedures WHERE name = 'CategoryInsert')
